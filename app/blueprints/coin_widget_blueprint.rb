class CoinWidgetBlueprint < Blueprinter::Base
  ...
  fields :base_currency, :quote_currency, :base_currency_id, :quote_currency_id, :change_up_to, :change_down_to, :exchange_id, :trade_history, :notification, :view_order, :cluster_id
